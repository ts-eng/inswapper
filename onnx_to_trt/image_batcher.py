...
class ImageBatcher:
    ...
    def __init__(self, input, shape, dtype, max_num_images=None, exact_batches=False, preprocessor="inswapper"):
        """
        ...
        :param preprocessor: Set the preprocessor to use.
        """
    ...
    def preprocess_image(self, image_path):
        ...
        if self.preprocessor == "inswapper":
